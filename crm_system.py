"""
Консольное приложение CRM-системы (Управление взаимоотношениями с клиентами).
Реализует учет товаров, сотрудников, пунктов продаж и финансовых операций.
Демонстрирует применение принципов ООП (Наследование, Полиморфизм, Инкапсуляция, Абстракция).
"""
...
class CRMSystem:
    """
    Главный управляющий класс (Контроллер).
